...
def get_shadow_answer(
    ...
    shadow_answer_in_db = crud.shadow_answers.get_shadow_answer(db=db, shadow_answer_uuid=shadow_answer_uuid)
...
def update_shadow_answer(
    ...
    if shadow_answer_in_db is None:
        ...
        crud.shadow_answers.create_shadow_answer(db=db, shadow_answer=shadow_answer_create)
    ...
    result = crud.shadow_answers.update_shadow_answer(db=db, shadow_answer_uuid=shadow_answer_uuid, shadow_answer=shadow_answer_update)
